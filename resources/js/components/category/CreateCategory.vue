<template>
    ...
    <v-btn color="pink" class="mr-4" type="submit" :disabled="disabled" v-if="editSlug">Update</v-btn>
    <v-btn color="teal" class="mr-4" type="submit" :disabled="disabled" v-else>Create</v-btn>
  </v-form>
